 ...
 * @returns
 */
export declare const setDocumentSideConfig: <V, T extends SideConfig<V>>(attrKey: string, isValidConfig: (config: T) => boolean, setNodesAttribute: (tr: Transaction, attr: string, value: any) => boolean) => (sideConfig: T) => ({ tr, dispatch }: {
    tr: Transaction;
    dispatch: Dispatch;
}) => boolean;
/**
 ...
 */
export declare const setPageSideConfig: <V, T extends SideConfig<V>>(setNodePosByPageNum: (doc: PMNode, pageNum: number) => Nullable<NodePos>, setGenericPageNodePosSideConfig: (tr: Transaction, dispatch: Dispatch, pagePos: number, pageNode: PMNode, sideConfig: T) => boolean) => (pageNum: number, sideConfig: T) => ({ tr, dispatch }: {
    tr: Transaction;
    dispatch: Dispatch;
}) => boolean;
/**
 ...
 */
export declare const setDocumentSideValue: <V, T extends SideConfig<V>>(setDocumentSideConfig: (sideConfig: T) => boolean, isValueValid: (value: V) => boolean, updateSideConfig: (tr: Transaction, pagePos: number, pageNode: PMNode, side: MultiAxisSide, value: V) => boolean) => (side: MultiSide, value: V) => ({ tr, dispatch }: {
    tr: Transaction;
    dispatch: Dispatch;
}) => boolean;
/**
 ...
 * @returns {boolean} True if the side value was set, false otherwise.
 */
export declare const setPageSideValue: <V, T extends SideConfig<V>>(setPageSideConfig: (pageNum: number, sideConfig: T) => boolean, isValueValid: (value: V) => boolean, updateSideConfig: (tr: Transaction, pagePos: number, pageNode: PMNode, side: MultiAxisSide, value: V) => boolean) => (pageNum: number, side: MultiSide, value: V) => ({ tr, dispatch }: {
    tr: Transaction;
    dispatch: Dispatch;
}) => boolean;
/**
 ...
 */
export declare const setPageNodePosSideConfig: <V, T extends SideConfig<V>>(tr: Transaction, dispatch: Dispatch, pagePos: number, pageNode: PMNode, configObj: T, isValidConfig: (config: T) => boolean, getPageNodeSideConfig: (pageNode: PMNode) => Nullable<T>, attrKey: string) => boolean;
/**
 ...
 */
export declare const updatePageSideConfig: <V, T extends SideConfig<V>>(tr: Transaction, pagePos: number, pageNode: PMNode, configObj: MultiAxisSide, value: V, getExistingConfig: (pageNode: PMNode) => Nullable<T>, isValidConfig: (config: T) => boolean, defaultConfig: T, attrKey: string) => boolean;
export {};
//# sourceMappingURL=setSideConfig.d.ts.map