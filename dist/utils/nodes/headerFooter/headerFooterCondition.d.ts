 ...
 */
export declare const isPosInPageAmendment: (doc: PMNode, $pos: ResolvedPos | number) => boolean;
/**
 ...
 */
export declare const isPosAtStartOfPageAmendment: (doc: PMNode, $pos: ResolvedPos | number) => boolean;
/**
 ...
 */
export declare const isPosAtFirstChildOfPageAmendment: (doc: PMNode, $pos: ResolvedPos | number) => boolean;
/**
 ...
 */
export declare const isPosAtEndOfPageAmendment: (doc: PMNode, $pos: ResolvedPos | number) => boolean;
/**
 ...
 */
export declare const isPosAtLastChildOfPageAmendment: (doc: PMNode, $pos: ResolvedPos | number) => boolean;
/**
 ...
 */
export declare const isPosMatchingStartOfPageAmendmentCondition: (doc: PMNode, $pos: ResolvedPos | number, checkExactStart: boolean) => boolean;
/**
 ...
 */
export declare const isPosMatchingEndOfPageAmendmentCondition: (doc: PMNode, $pos: ResolvedPos | number, checkExactEnd: boolean) => boolean;
//# sourceMappingURL=headerFooterCondition.d.ts.map