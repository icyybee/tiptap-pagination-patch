 ...
 */
export declare const nodeHasAttribute: (node: PMNode, attr: string) => boolean;
/**
 ...
 * attributes.
 */
export declare const parseHTMLNodeGetAttrs: (nodeTagAttribute: string, preventNestedNodes: boolean) => (node: HTMLElement) => Attrs | false | null;
